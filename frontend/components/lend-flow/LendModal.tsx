        ...
        <div className="flex flex-col gap-4 justify-center ">
          ...
          <div>
            ...
            <a
              target={"_blank"}
              rel="noreferrer"
              href={`https://mumbai.polygonscan.com/address/${tx?.hash}`}
              className="text-sm flex items-center gap-2 text-blue-500 hover:underline underline-offset-4"
            >
          ...
          <div>
            ...
            <a
              target={"_blank"}
              rel="noreferrer"
              href={`https://mumbai.polygonscan.com/address/${loanAddress}`}
              className="text-sm flex items-center gap-2 text-blue-500 hover:underline underline-offset-4"
            >
              {loanAddress} <FiExternalLink />
            </a>
          </div>
